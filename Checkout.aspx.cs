...
public partial class Checkout : System.Web.UI.Page
{
    ...
    protected void Page_LoadComplete(object sender, EventArgs e)
    {
        ...
        string strEmailTo = User.Identity.Name + "@gmail.com"; //Note that username is the same as the email address in Visual Studio Community 2015.
        string strEmailFrom = "yaochen2@uic.edu"; //put a valid gmail account here to represent the company's email.
        ...
        //change "throw-awayAccount@gmail.com" with a valid Gmail account and "password" with
        ...
        smtpClient.Credentials =
            new System.Net.NetworkCredential("yaochen2@uic.edu", "Tbc:45615464");
